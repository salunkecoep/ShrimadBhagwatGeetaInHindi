...
export class HomePage implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    var that = this;
    this.audioPlayer.addEventListener('ended', function () { return that.playNextAudio(); });
  ...
  public openRateUsDialog() {
    window.location.href = "https://play.google.com/store/apps/details?id=com.precious.shrimad.bhagwat.geeta.in.hindi"
  }
  ...
  public shareApp() {
    let url = "https://play.google.com/store/apps/details?id=com.precious.shrimad.bhagwat.geeta.in.hindi"
